...
export interface MyWalletDeployerInterface extends utils.Interface {
  functions: {
    "deployWallet(address,address,uint256,uint256[2],address)": FunctionFragment;
    "getDeploymentAddress(address,address,uint256,uint256[2],address)": FunctionFragment;
  };
