...
export interface MyTouchIdWalletInterface extends utils.Interface {
  functions: {
...
export interface MyTouchIdWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyTouchIdWalletInterface;
