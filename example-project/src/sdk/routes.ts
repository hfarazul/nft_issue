...
const SERVER_URL = 'https://banana-mapper.onrender.com'
...
export { ADD_WALLETCRED_ROUTE, GET_WALLETCRED_ROUTE, CHECK_INITCODE_ROUTE, IS_WALLETNAME_UNIQUE_ROUTE, SERVER_URL, REGISTRATION_LAMBDA_URL, VERIFICATION_LAMBDA_URL }